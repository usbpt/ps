...
Start-Process iexplore.exe '-k http://fakebsod.com/windows-8-and-10'

New-ItemProperty HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Run\ -Name "Darn" -Value "C:\windows\system32\calc.exe"
